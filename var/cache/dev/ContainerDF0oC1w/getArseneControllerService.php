 ...
 */
class getArseneControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\ArseneController' shared autowired service.
     *
     * @return \App\Controller\ArseneController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ArseneController.php';

        $container->services['App\\Controller\\ArseneController'] = $instance = new \App\Controller\ArseneController();
        ...
        ]))->withContext('App\\Controller\\ArseneController', $container));
